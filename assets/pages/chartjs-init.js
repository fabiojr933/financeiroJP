    ...
    var myChart = new Chart(ctx, {
        type: 'bar', data: {
            labels: ["January", "February", "March", "April", "May", "June", "July"], datasets: [{
                label: "My First dataset", data: [65, 59, 80, 81, 56, 55, 40], borderColor: "rgba(67, 107, 56, 1)", borderWidth: "0", backgroundColor: "rgba(102, 166, 84, 1)"
            }
                , {
                label: "My Second dataset", data: [28, 48, 40, 19, 86, 27, 90], borderColor: "rgba(34, 56, 100, 1)", borderWidth: "0", backgroundColor: "rgba(34, 56, 100, 1)"
            }
            ]
        }
        , options: {
